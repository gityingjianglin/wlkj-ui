    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="wl-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="wl-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'wlkj-ui/src/utils/dom';
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['wl-icon-CheckCircleOutline', 'wl-icon-CheckCircleOutline', 'wl-icon-CheckCircleOutline'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'wl-icon-CheckCircleOutline'
      },
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'wl-rate__item')) {
            target = target.querySelector('.wl-rate__icon');
          }
          if (hasClass(target, 'wl-rate__decimal')) {
