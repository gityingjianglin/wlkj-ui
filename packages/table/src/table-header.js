import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'wlkj-ui/src/utils/dom';
...
export default {
        ...
        <thead class={ [{ 'is-group': isGroup, 'has-gutter': this.hasGutter }] }>
          {
            this._l(columnRows, (columns, rowIndex) =>
              ...
              >
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="wl-table__column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <i class={ ['wl-icon-arrow-down', column.filterOpened ? 'wl-icon-arrow-up' : ''] }></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
                ...
                {
                  this.hasGutter ? <th class="wl-table__cell gutter"></th> : ''
                }
              </tr>
            )
          }
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.wl-table__column-filter-trigger') || cell;
