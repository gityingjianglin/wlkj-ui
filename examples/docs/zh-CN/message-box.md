...
```html
<template>
  <wl-button type="text" @click="open">点击打开 Message Box</wl-button>
</template>
...
<script>
  export default {
    methods: {
      open() {
        this.$alert('一系列的信息描述，可能会很长。也可以是很短同样也可以带标点。', '通知信息标题', {
...
```html
<template>
  <wl-button type="text" @click="openSuccess">点击打开 success Message Box</wl-button>
  <wl-button type="text" @click="openError">点击打开 error Message Box</wl-button>
  <wl-button type="text" @click="openInfo">点击打开 info Message Box</wl-button>
  <wl-button type="text" @click="openWarning">点击打开 warning Message Box</wl-button>
</template>
...
<script>
  export default {
    methods: {
      openWarning() {
        this.$confirm('一系列的信息描述，可能会很长。也可以是很短同样也可以带标点。', '通知信息标题', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning',
          center: true
