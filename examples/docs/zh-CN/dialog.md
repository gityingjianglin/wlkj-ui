...
```html
<template>
  <wl-button type="text" @click="outerVisible = true">点击打开外层 Dialog</wl-button>
  
  <wl-dialog title="外层 Dialog" :visible.sync="outerVisible">
    <wl-dialog
      width="30%"
      title="内层 Dialog"
    ...
    <div slot="footer" class="dialog-footer">
      <wl-button @click="outerVisible = false">取 消</wl-button>
      <wl-button type="primary" @click="innerVisible = true">打开内层 Dialog</wl-button>
    </div>
  </wl-dialog>
</template>
...
```html
<wl-button type="text" @click="centerDialogVisible = true">点击打开 Dialog</wl-button>
...
<wl-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <wl-button @click="centerDialogVisible = false">取 消</wl-button>
    <wl-button type="primary" @click="centerDialogVisible = false">确 定</wl-button>
  </span>
</wl-dialog>
