<template>
  ...
  >
    <template v-if="type !== 'textarea'">
      <!-- 前置元素 -->
      <div class="wl-input-group__preped" v-if="$slots.prepend">
      ...
      <span
        ...
        <span class="wl-input__suffix-inner">
          ...
          <i v-if="showClear"
            class="wl-input__icon wl-icon-CloseCircleOutlined wl-input__clear"
            @mousedown.prevent
            @click="clear"
          >
          </i>
          <i v-if="showPwdVisible"
            class="wl-input__icon wl-icon-EyeOutline wl-input__clear"
      ...
      <!-- 后置元素 -->
      <div class="wl-input-group__append" v-if="$slots.append">
